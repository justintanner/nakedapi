...
describe("openai fine-tuning", () => {
  describe("payload validation", () => {
    ...
    it("should expose payloadSchema on jobs create", () => {
      const schema = provider.v1.fine_tuning.jobs.payloadSchema;
    ...
    it("should validate create request - valid", () => {
      const result = provider.v1.fine_tuning.jobs.validatePayload({
    ...
    it("should expose payloadSchema on checkpoint permissions create", () => {
      const schema =
        provider.v1.fine_tuning.checkpoints.permissions.payloadSchema;
      expect(schema.method).toBe("POST");
    ...
    it("should validate checkpoint permissions create - valid", () => {
      const result =
        provider.v1.fine_tuning.checkpoints.permissions.validatePayload({
  ...
  describe("namespace wiring", () => {
    ...
    it("should expose fine_tuning.jobs as callable with child methods", () => {
      ...
      expect(typeof provider.v1.fine_tuning.jobs.pause).toBe("function");
      expect(typeof provider.v1.fine_tuning.jobs.resume).toBe("function");
      expect(typeof provider.v1.fine_tuning.jobs.events).toBe("function");
      expect(typeof provider.v1.fine_tuning.jobs.checkpoints).toBe("function");
    });

    it("should expose fine_tuning.checkpoints.permissions as callable with child methods", () => {
      expect(typeof provider.v1.fine_tuning.checkpoints.permissions).toBe(
        "function"
      );
      expect(typeof provider.v1.fine_tuning.checkpoints.permissions.list).toBe(
        "function"
      );
      expect(typeof provider.v1.fine_tuning.checkpoints.permissions.del).toBe(
        "function"
      );
    });
  });
