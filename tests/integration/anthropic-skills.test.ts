...
describe("anthropic skills", () => {
  ...
  it("should create a skill with files", async () => {
  ...
  it("should create a skill version", async () => {
  ...
  it("should list skill versions", async () => {
  ...
  it("should delete a skill version", async () => {
    ...
    const skill = await provider.v1.skills.create("Skill For Version Delete", [
      { data: file, path: "skill.json" },
    ]);
